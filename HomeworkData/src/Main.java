...
public class Main {
	 ...
	 */
	public static ArrayList<String[]> readFile(String dir, String file, boolean allowEmptyLines) throws IOException {
	...
	private static boolean timePerUnit(ArrayList<String[]> dataSheet, int row) {
		return false;
	}
