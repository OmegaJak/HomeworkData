...
/**
 * JavaFX Control that behaves like a {@link JSpinner} known in Swing. The number in the textfield can be incremented or decremented by a configurable stepWidth
 * using the arrow buttons in the control or the up and down arrow keys.
 *
 * @author Thomas Bolz Originally taken from this post: http://java.dzone.com/articles/javafx-numbertextfield-and It has since been modified by me, OmegaJak
 */
