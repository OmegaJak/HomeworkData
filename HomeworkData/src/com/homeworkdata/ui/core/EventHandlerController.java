...
import com.homeworkdata.helper.StreamCapturer;
import com.homeworkdata.helper.enums.Columns;
import com.homeworkdata.ui.custom.control.AutoCompleteComboBoxListener;
...
public class EventHandlerController {
	...
	private void showPreferences() {
		try {
			...
			FXMLLoader loader = new FXMLLoader(GUI.class.getResource("/resources/Preferences.fxml"));
			loader.setController(new PreferencesHandler());
