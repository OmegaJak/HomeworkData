 ...
 *
 *
 * I (OmegaJak) had to copy this class so I could make changes to it, that would make making subclasses not impossible. Same with Chart. Really unhappy with Oracle on this.
 */
